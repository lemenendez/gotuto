...
Let us assume the following formula for displacement s:
 as a function of time t, acceleration a, initial velocity vo, 
...
computes displacement as a function of time, assuming the given values acceleration, 
initial velocity, and initial displacement. 
...
func main() {
	...
	fmt.Printf("Displament after %v s is: %v\n",t, fn(t))
